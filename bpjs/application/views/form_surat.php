...
<body>
	...
	<form method = "POST" action = "<?php echo site_url('surat/simpan_surat');?>">
		<div class="form-group">
			<input type = "text" name="ID_SuratRujukan" class = "form-control" placeholder="Nomor Surat Rujukan">
		</div>
		<div class="form-group">
			  <label>Tanggal</label>
		...
		<center><button type="submit" class="btn btn-success">Simpan</button>
